<?php
class Rdx_GDPR_CustomerController extends Mage_Core_Controller_Front_Action
{
    ...
    public function deleteaccountAction() {
        ...
        if (!$customer) {
            Mage::getSingleton('customer/session')->setBeforeAuthUrl(Mage::getUrl('rdx_gdpr/customer/deleteaccount'));
            $this->_redirect('customer/account/login');
            return;
        }
        ...
        $successMessage = Mage::helper('rdx_gdpr')->getSuccessMessage();
