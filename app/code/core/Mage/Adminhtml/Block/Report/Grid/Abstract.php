...
class Mage_Adminhtml_Block_Report_Grid_Abstract extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        //print 'here:';print_r($resourceCollection);
        ...
        //$this->getCollection()->getSelect()->join('sales_flat_order', 'main_table.customer_group_id = sales_flat_order.customer_group_id',array('1'));
        //$this->getCollection()->getSelect()->join('sales_flat_order_item', '`sales_flat_order_item`.order_id=`main_table`.entity_id', array('skus'  => new Zend_Db_Expr('group_concat(`sales_flat_order_item`.sku SEPARATOR ", ")')));
