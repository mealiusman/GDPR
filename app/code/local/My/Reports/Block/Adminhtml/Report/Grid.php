    ...
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('customer_group_id', array(
            'header'            => Mage::helper('my_reports')->__('Customer Group'),
            'index'             => 'customer_group_id', // 'index' attaches a column from the SQL result set to the grid
    ...
    {
        //print_r($filterData->getData('customer_group_id'));echo '<hr>';
        ...
        $collection
            ...
            ->customerGroupFilter($filterData->getData('customer_group_id'))
