    ...
    extends Mage_Core_Model_Mysql4_Collection_Abstract
{
     ...
     * @var bool
     */
    protected $_isCustomerGroupFilter            =  false;
     ...
     * @var bool
     */
    protected $_customerGroupFilterId            = -1;
     ...
     * @return bool|My_Reports_Model_Mysql4_Report_Collection
     */
    public function customerGroupFilter($customerGroupId = '1000')
    {
        print $customerGroupId;
        //Check if group filter is not set to all
        if ($customerGroupId != '1000') {
            $this->_isCustomerGroupFilter = true;
            $this->_customerGroupFilterId = $customerGroupId;

            print 'Customer Group: '.$this->_isCustomerGroupFilter;
            print 'Customer Group Id: '.$this->_customerGroupFilterId;
            print '<hr>';
        }
    ...
    {
        //print 'ID: '.$this->_customerGroupFilterId;
        if ($this->_isCustomerGroupFilter) {

            echo $this->getSelect()
                //->columns(array('customer_group_id'))
                ->where('customer_group_id = ?',$this->_customerGroupFilterId);
        }
